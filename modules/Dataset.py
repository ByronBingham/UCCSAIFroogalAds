...
class YoloV3Dataset(object):
    ...
    def __init__(self, dataset_type):
        ...
        self.open_images_v4 = self.open_images_v4.prefetch(100)
        self.ds_iterator = iter(self.open_images_v4)
    ...
    def __next__(self):
        with tf.device('/cpu:0'):
            ...
            for e in range(Constants.BATCH_SIZE):
                ...
                image = np.asarray(tf.cast(element["image"], dtype=tf.float32)) / 255.0
                ...
                tmp.save("./test/img" + str(self.tmp_count) + ".png")
                self.tmp_count += 1
                """
                num += 1
